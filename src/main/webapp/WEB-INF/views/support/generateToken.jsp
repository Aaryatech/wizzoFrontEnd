				...
				<form name="frm_search" id="frm_search" method="post"
					...
					<input type="hidden" name="mod_ser" id="mod_ser"
						...
						<div class="col-md -3">
								...
								<div class="col1title" align="left"><h3>Generate Token</h3></div>
					...
					<div class="colOuter">
						...
						<div class="col-md-3">
						<textarea class="form-control"   style="text-align: left;" name="issue" id="issue" placeholder="Issue" required>${getSupportById.issueDesc}</textarea>
						...
						<div class="col-md-3">
						<textarea class="form-control" style="text-align: left;" name="solution" id="solution" placeholder="Solution Provided">${getSupportById.solutionProvided}</textarea>
					...
					<div class="colOuter">
						...
						<div class="col-md-3">
							<select class="selectpicker" onchange="validation()" data-live-search="true" title="Please Select" 
