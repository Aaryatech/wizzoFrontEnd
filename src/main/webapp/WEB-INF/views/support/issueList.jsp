						...
						<nav>
							<ul class="cd-tabs-navigation">
								<li id="li1"><a data-content="tab1" class="selected" href="#0"
									onclick="onloadTab(1)" onshow="onloadTab(2)">Ongoing</a></li>
								<li id="li2"><a data-content="tab2" href="#0" onclick="onloadTab(2)">Resolved</a></li>
										...
										<table id="table_grid1" class="main-table small-td">
											<thead>
												<tr class="bgpink">
													...
													<th class="col-md-1">Assign To</th> 
													<th class="col-md-1">Action</th>
												</tr>
											</thead>
											<tbody>
											
											<c:forEach items="${pendingListFromSupprt}" var="pendingListFromSupprt"
													varStatus="count">
													  
													<tr>
												     
														<td ><c:out value="${count.index+1}" /></td> 
														<td ><c:out value="${pendingListFromSupprt.userName}" /></td>
														<td ><c:out value="${pendingListFromSupprt.issueRaisedDatetime}" /></td>  
												 	 	<td  ><c:out value="${pendingListFromSupprt.empName}" /> </td>
												 	 	  <td  ><a href="${pageContext.request.contextPath}/resolvedIssue/${pendingListFromSupprt.tokenId}" class="action_btn" ><input type="button" class="btn additem_btn" value="Resolve"
												id="b1"/> </a>  </td> 
													</tr>
										...
										<table id="table_grid2" class="main-table small-td">
											<thead>
												<tr class="bgpink">
													...
													<th class="col-md-1">User Name</th>
													<th class="col-md-2">Issue Date</th>
													<th class="col-md-2">Resolved Date</th>
													<th class="col-md-1">Assign To</th> 
													<th class="col-md-1">Action</th> 
												</tr>
											</thead>
											<tbody> 
											<c:forEach items="${resolvedListFromSupprt}" var="resolvedListFromSupprt"
													varStatus="count">
													  
													<tr>
												     
														<td ><c:out value="${count.index+1}" /></td> 
														<td ><c:out value="${resolvedListFromSupprt.userName}" /></td>
														<td ><c:out value="${resolvedListFromSupprt.issueRaisedDatetime}" /></td> 
														<td ><c:out value="${resolvedListFromSupprt.solutionDatetime}" /></td>   
												 	 	<td  ><c:out value="${resolvedListFromSupprt.empName}" /> </td>
												 	 	 <td  ><a href="${pageContext.request.contextPath}/detailIssue/${resolvedListFromSupprt.tokenId}" class="action_btn" ><input type="button" class="btn additem_btn" value="Detail"
												id="b1"/> </a>  </td> 
													</tr>
