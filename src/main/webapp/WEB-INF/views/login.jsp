		...
		<div class="fullGrid center logoBarbg slideposi">
			<div class="wrapperIn positionR">
				<div class="logoBarLeft">
					<a href=""><img
						src="${pageContext.request.contextPath}/resources/images/monginislogoo.png"
						alt="monginis"></a>
				</div>
						...
						<div class="loginBox">
							...
							<form action="login" class="form-horizontal" id="validation-form"
								...
								<div class="loginfildset">
									<input class="texboxlogin" placeholder="MobileNo"
										name="empMobile" type="text" data-rule-required="true">
								</div>
								<div class="loginfildset">
									<input class="texboxlogin" placeholder="Password"
										name="empPassword" type="password" required>
								</div>
								...
								<div class="loginfildset">
									<div class="logintexboxleft">
										<a href="showforgotpassword"><i class="fa fa-lock"></i>
